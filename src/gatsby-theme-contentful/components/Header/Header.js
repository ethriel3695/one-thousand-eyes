...
import { useBrandData } from 'gatsby-theme-contentful/src/hooks/brandData';
import useIsIOS from 'gatsby-theme-contentful/src/utils/useIsIOS';
// import Transition from './Transition.js';
import MenuMobile from 'gatsby-theme-contentful/src/components/Menu/MenuMobile';
// import SimpleDialogDemo from '../Modal/Modal';
import { useSlugList } from 'gatsby-theme-contentful/src/hooks/slugList';
import { buildNav } from 'gatsby-theme-contentful/src/utils/buildNav';
        ...
        <div className="hidden sm:block">
          {navs.map((nav, key) => (
            <Link
              ...
              className="ml-6 sm:ml-8 text-sm sm:text-base font-medium px-px border-b-2 pb-2 border-transparent text-gray-700 hover:text-gray-800 hover:border-blue-700 transition duration-150 ease-in-out no-underline"
